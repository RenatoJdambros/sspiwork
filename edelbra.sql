...
--
-- Host: 127.0.0.1
-- Generation Time: 20-Jul-2019 às 04:39
...
CREATE TABLE `sacp` (
  ...
  `avaliacao` varchar(5000) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `sacp` (`id`, `setor_origem`, `setor_destino`, `status`, `origem`, `descricao`, `proposito`, `consequencia`, `brainstorming`, `data_gerada`, `data_prazo`, `data_finalizada`, `numero_op`, `id_rnc`, `avaliacao`) VALUES
(36, 2, 3, 3, 'arroba teu cu', 'a', 'a', 'a', 'a', '2019-06-19 20:26:54', '0000-00-00 00:00:00', '2019-06-23 23:24:17', 90, NULL, 'fdsfds'),
(37, 2, 6, 2, 'relatorio', 'a', 'a', 'a', 'a', '2019-06-22 18:52:48', '0000-00-00 00:00:00', '2019-06-23 22:48:23', 123, NULL, NULL),
(38, 3, 3, 1, 'recebida', 'easeas', 'easeas', 'easeas', 'easeas', '2019-06-22 19:47:59', '0000-00-00 00:00:00', NULL, 123, NULL, NULL),
(39, 7, 2, 1, 'relatorio', 's', 's', 's', 'a', '2019-06-22 20:07:01', '2019-07-22 20:07:01', NULL, NULL, NULL, NULL),
(40, 3, 6, 1, 'relatorio', 'dadas', 'eaeas', 'easeas', 'easeas', '2019-06-22 20:41:31', '2019-07-22 20:41:31', NULL, 123, 23, NULL),
(41, 7, 6, 1, 'relatorio', 'de user A para user C', 'easeas', 'easeas', 'easeas', '2019-06-22 20:47:42', '2019-07-22 20:47:42', NULL, NULL, 19, NULL),
(42, 3, 5, 1, 'relatorio', 'easeas', 'easeas', 'easeas', 'easeas', '2019-06-22 20:48:11', '2019-07-22 20:48:11', NULL, 2312321, NULL, NULL),
(43, 7, 6, 1, 'relatorio', 'easeas', 'easeas', 'easeas', 'easeas', '2019-06-22 20:49:55', '2019-07-22 20:49:55', NULL, 123, NULL, NULL),
(44, 7, 6, 1, 'relatorio', 'easeas', 'easeas', 'easeas', 'easeas', '2019-06-22 20:50:20', '2019-07-22 20:50:20', NULL, 123, NULL, NULL),
(45, 7, 6, 1, 'relatorio', 'easeas', 'easeas', 'easeas', 'easeas', '2019-06-22 20:50:59', '2019-07-22 20:50:59', NULL, NULL, NULL, NULL),
(46, 7, 6, 1, 'relatorio', 'easeas', 'easeas', 'easeas', 'easeas', '2019-06-22 20:51:25', '2019-07-22 20:51:25', NULL, NULL, NULL, NULL),
(47, 7, 6, 1, 'relatorio', 'easeas', 'easeas', 'easeas', 'easeas', '2019-06-22 20:52:37', '2019-07-22 20:52:37', NULL, NULL, NULL, NULL),
(48, 7, 6, 1, 'relatorio', 'easeas', 'easeas', 'easeas', 'easeas', '2019-06-22 20:53:06', '2019-07-22 20:53:06', NULL, NULL, NULL, NULL),
(49, 7, 6, 1, 'relatorio', 'easeas', 'easeas', 'easeas', 'easeas', '2019-06-22 20:53:21', '2019-07-22 20:53:21', NULL, NULL, NULL, NULL),
(50, 7, 6, 1, 'relatorio', 'easeas', 'easeas', 'easeas', 'easeas', '2019-06-22 20:53:33', '2019-07-22 20:53:33', NULL, NULL, NULL, NULL),
(51, 7, 6, 1, 'relatorio', 'easeas', 'easeas', 'easeas', 'easeas', '2019-06-22 20:53:41', '2019-07-22 20:53:41', NULL, NULL, NULL, NULL),
(52, 7, 6, 1, 'relatorio', 'easeas', 'easeas', 'easeas', 'easeas', '2019-06-22 20:54:03', '2019-07-22 20:54:03', NULL, NULL, NULL, NULL),
(53, 7, 6, 1, 'relatorio', 'easeas', 'easeas', 'easeas', 'easeas', '2019-06-22 20:54:32', '2019-07-22 20:54:32', NULL, NULL, NULL, NULL),
(54, 3, 6, 1, 'riscos', 'de user A para user C', 'easesae', 'easeas', 'easeas', '2019-06-22 20:57:10', '2019-07-22 20:57:10', NULL, NULL, 19, NULL),
(55, 3, 6, 1, 'riscos', 'de user A para user C', 'easesae', 'easeas', 'easeas', '2019-06-22 20:57:26', '2019-07-22 20:57:26', NULL, NULL, 19, NULL),
(56, 7, 5, 1, 'relatorio', 'de user A para user C', 'a', 'a', 'a', '2019-06-22 21:02:16', '2019-07-22 21:02:16', NULL, NULL, 19, NULL),
(57, 7, 7, 2, 'relatorio', 'de user A para user C', 'easeaseas', 'easeas', 'easeaseas', '2019-06-22 21:06:57', '2019-07-22 21:06:57', NULL, NULL, 19, NULL),
(58, 7, 7, 2, 'relatorio', 'de user A para user C', 'easeaseas', 'easeas', 'easeaseas', '2019-06-22 21:07:29', '2019-07-22 21:07:29', NULL, NULL, 19, NULL);

-- --------------------------------------------------------

--
-- Stand-in structure for view `sacp_dados_fk`
-- (See below for the actual view)
--
CREATE TABLE `sacp_dados_fk` (
`id` int(11)
,`setor_origem` varchar(255)
...
(19, 'usuário A', 2, 'usuarioA@edelbra.com.br', 'usuarioA', '$2a$08$dMoCrtIiDZl4KWU1H3PI1e2ccGF9j2PFYoTTds5nPpN8XaKsi1gka', 3, 'ativo', 'a2ht5leoa02vv4bq8gr3dqnpmv'),
(20, 'usuário B', 6, 'usuarioB@edelbra.com.br', 'usuarioB', '$2a$08$aJFwqAflqJahcDAObDPis.pxwH/dUIr73FUh29vX6GPH4o9Hseqf2', 3, 'ativo', 'ondbap8n93e9vc0h52o339rst5'),
...
(22, 'Administrador', 2, 'administrador@edelbra.com.br', 'admin', '$2a$08$vfXLeWf8sxOPX36Ioo0tX.PQlpSAtegW2MdvngEY88UElveO4GDs2', 1, 'ativo', 'q89fnqvhflv0qgjd6eh2c4v1ul'),
...
--
-- Structure for view `sacp_dados_fk`
--
DROP TABLE IF EXISTS `sacp_dados_fk`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `sacp_dados_fk`  AS  select `sacp`.`id` AS `id`,`setororigem`.`nome` AS `setor_origem`,`setordestino`.`nome` AS `setor_destino`,`status`.`nome` AS `status`,`sacp`.`numero_op` AS `numero_op`,`sacp`.`id_rnc` AS `id_rnc`,`sacp`.`data_gerada` AS `data_gerada`,`sacp`.`data_prazo` AS `data_prazo`,`sacp`.`data_finalizada` AS `data_finalizada` from (((`sacp` join `status` on((`sacp`.`status` = `status`.`id`))) join `setores` `setororigem` on((`sacp`.`setor_origem` = `setororigem`.`id`))) join `setores` `setordestino` on((`sacp`.`setor_destino` = `setordestino`.`id`))) ;
