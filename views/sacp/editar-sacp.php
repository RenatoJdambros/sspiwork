...
<div class="row">
   ...
   <div class="form-group col-md-2">
      ...
      <input style="min-width: 20px; max-width: 178px;" value="<?= $dados['numero_op'] ? $dados['numero_op'] : '' ?>" style="min-width: 20px; max-width: 158px;" type="text" class="form-control" id="numero_op" name="numero_op" >
    </div>
    </div>
...
<div class="container-fluid">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control rounded-0" id="proposito" rows="4" name="proposito" required><?= $dados['proposito'] ?></textarea>
  </div> 

  <div class="form-group">
    <label for="consequencia">Consequências da mudança:</label>
    <textarea class="form-control rounded-0" id="consequencia" rows="4" name="consequencia" required><?= $dados['consequencia'] ?></textarea>
